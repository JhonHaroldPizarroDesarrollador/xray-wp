...
function twentyseventeen_scripts() {
	...
	wp_enqueue_script( 'require', get_theme_file_uri( '/assets/js/require.js' ), array( 'jquery' ), '2.3.6', true );

	//wp_enqueue_script( 'xray-web-scraping', get_theme_file_uri( 'xray.js' ), array( 'jquery' ), '2.3.6', true );
